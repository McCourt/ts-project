...
We then proceed to fit ARIMA time series models for each of the three companies of interest. The model is specified as follows:
...
>>>>>>> c886ed97cc392223906d11a11027a6a4fff14490
  for (i in 1:(N-1)) {
    for (j in (i+1):N) {
...
=======
>>>>>>> 23d6a03834fa194950dec279067aa6ceffdce848
=======
...
reps=1000
x = subset$Open + rnorm(252, 0.01)
y = subset$apple_close
x_pred = subset$Open + rnorm(252, 0.01)
mu = beta0 + beta1*x
