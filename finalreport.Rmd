...
source("util.R")
apple_emp_cloud = apple.stock %>% emp_semivariogram(Close,Date)

apple_emp = rbind(
  apple.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.05)  %>% mutate(binwidth="binwidth=0.05"),
  apple.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.075) %>% mutate(binwidth="binwidth=0.075"),
  apple.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.1)   %>% mutate(binwidth="binwidth=0.1"),
  apple.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.15)  %>% mutate(binwidth="binwidth=0.15")
)
...
```{r echo=FALSE, fig.height=4.5}
amazon_emp_cloud = amazon.stock %>% emp_semivariogram(Close,Date)

amazon_emp = rbind(
  amazon.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.05)  %>% mutate(binwidth="binwidth=0.05"),
  amazon.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.075) %>% mutate(binwidth="binwidth=0.075"),
  amazon.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.1)   %>% mutate(binwidth="binwidth=0.1"),
  amazon.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.15)  %>% mutate(binwidth="binwidth=0.15")
)
...
```{r echo=FALSE, fig.height=4.5}
facebook_emp_cloud = facebook.stock %>% emp_semivariogram(Close,Date)

facebook_emp = rbind(
  facebook.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.05)  %>% mutate(binwidth="binwidth=0.05"),
  facebook.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.075) %>% mutate(binwidth="binwidth=0.075"),
  facebook.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.1)   %>% mutate(binwidth="binwidth=0.1"),
  facebook.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.15)  %>% mutate(binwidth="binwidth=0.15")
)
...
```{r echo=FALSE, fig.height=4.5}
google_emp_cloud = google.stock %>% emp_semivariogram(Close,Date)

google_emp = rbind(
  google.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.05)  %>% mutate(binwidth="binwidth=0.05"),
  google.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.075) %>% mutate(binwidth="binwidth=0.075"),
  google.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.1)   %>% mutate(binwidth="binwidth=0.1"),
  google.stock %>% emp_semivariogram(Close, Date, bin=TRUE, binwidth=0.15)  %>% mutate(binwidth="binwidth=0.15")
)
